var rule = {
    ...
    class_name:'快船赛程&快船集锦&快船录像&快船视频',
    class_url:'game&jijin&replay&zhibo8',
    filterable: 1,
...
//     `,
    ...
    一级: `js:
        ...
        else if(MY_CATE==='replay'){
            var cateId = MY_FL.cateId || '篮球屋';
            
            var vodList = '';
            var vodDetail = '';
            
            if(cateId==='量子源' || cateId==='天空源' || cateId==='飞速源'){
                if(cateId==='量子源'){
                ...
                var list1 = JSON.parse(request(vodList+MY_PAGE+'&wd=%E5%BF%AB%E8%88%B9')).list;
                ...
                if(ids!=='') {
                    ...
                    list2.forEach(it => {
                        ...
                        if(cateId==='量子源'){
                            // 客队vs主队
                            Team1vsTeam2 = it.vod_name.split(' ')[1].substring(0, it.vod_name.split(' ')[1].length-8);
                            // 一级描述
