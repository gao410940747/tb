...
var rule = {
    ...
    // 二级:'*',
    二级:`js:
        let aid=input.match(/\\/(\\d+)/)[1];
        log(aid);
        let html=request('https://api.live.bilibili.com/room/v1/Room/get_info?room_id='+aid);
        ...
        let vod={
            ...
            type_name:typeName,
            vod_remarks:remark,
            vod_actor:'🆙 '+dire+'｜ 👥 '+remark,
            vod_director:'🚪 直播间id：'+aid,
            vod_content:desc
        };
