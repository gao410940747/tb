var rule = {
    ...
    class_name:'篮球屋录像&NBA录像&NBA集锦&NBA十佳球&88比赛录像&NBA&直播吧视频',
    class_url:'lanqiuwu&nbalx&nbajijin&nbatop10&88replay&1&zhibo8',
    headers:{
        'User-Agent':'PC_UA'
    },
    timeout:15000,
    ...
    一级:`js:
        ...
        if(MY_CATE==='zhibo8'){
            ...
            if(MY_PAGE===1) {
                ...
                html = request('https://lanqiuwu.com/list/index_'+MY_PAGE+'.html');
            }
