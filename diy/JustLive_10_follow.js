...
//                html = JSON.parse(request('https://api.live.bilibili.com/xlive/web-interface/v1/second/getList?platform=web&parent_area_id=2&area_id=87&sort_type=online&page=1')).data.list;
        ...
        if (MY_CATE === 'douyin') {
            ...
            } else if (area === '守望先锋(晴雅线路)' || area === '周杰伦') {
                douyinow = true;
                var douyinList = JSON.parse(request('http://cfmqy.cn/tv/live.php?type=search&page='+(MY_PAGE-1)+'&wd='+area)).data.list;
