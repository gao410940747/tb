var rule = {
    ...
    推荐:`js:
        ...
        try{
            ...
            arr.forEach(function(item){
                if(item.type==="movie"||item.type==="tv"){
                    ...
                    let honnor=(item.honor_infos||[]).map(function(it){
                        return it.title
                    }).join("|");
                    lists.append({vod_id:"msearch:"+TYPE,vod_name:item.title||"",vod_pic:item.pic.normal,vod_remarks:rating+" "+honnor})
                }
            });
            return lists
        }
        ...
        VODS=subject_real_time_hotest();print(VODS);
    `,
