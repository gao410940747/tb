    ...
    二级: `js:
        if (/快手/.test(input)) {
            ...
            VOD = {
                ...
                vod_director: '🚪 房间号：' + jo.roomId + '｜ 📝 状态：' + (jo.isFollowed == 1 ? '已关注' : '未关注') + (jo.isLive == 0 ? '，未开播' : ''),
